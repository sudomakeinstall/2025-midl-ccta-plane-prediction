...
This repository contains the code to reproduce results for the following article, which has been submitted to *Medical Imaging with Deep Learning* 2025 and is currently under review:
    ...
    Vigneault DM, Manohar A, Hernandez A., *et al*, Cardiac Computed Tomography Angiography Plane Prediction and Comprehensive LV Segmentation. MIDL 2025. Salt Lake City, UT, USA. (Under Review)
...
<img src="fig-1-cardiac-rebuttal.svg" alt="architecture" width="100%"/>
